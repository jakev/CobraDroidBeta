...
public class DefaultHttpClient extends AbstractHttpClient {
    ...
    public DefaultHttpClient(
        ...
        super(_getCCM(conman, params), params);
    }
    
    public DefaultHttpClient(final HttpParams params) {
        super(_getSCCM(), params);
    }
    ...
    //This method creates a SingleClientConnManager that trusts everyone!
    private static ClientConnectionManager _getSCCM() {
	
	//If ModState is not enabled, just return "null"
	...
	return null;
     ...
     private static ClientConnectionManager _getTSCCM(HttpParams params) {
    ...
    private static ClientConnectionManager _getCCM(ClientConnectionManager conman, HttpParams params) {

	//If ModState is not enabled, just return conman
	if (!ModState.getInstance(ModState.SSL).getState()) {
		return conman;
	}
	
    	String className = conman.getClass().getSimpleName();
    	
    	if (className.equals("SingleClientConnManager")) {
    		return _getSCCM();
    	}
    	else if (className.equals("ThreadSafeClientConnManager")) {
    		return _getTSCCM(params);
      	}
